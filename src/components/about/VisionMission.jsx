...
export default function VisionMissionSection({ bg }) {
  ...
  return (
    <section
      className={`py-20 ${bg} overflow-hidden text-right`}
      dir={isRtl ? "rtl" : "ltr"}
    >
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <span className="absolute top-8 left-8 text-7xl font-black text-white/5 group-hover:text-white/10 transition-colors duration-500 font-mono select-none">
              01
            </span>
            ...
            <div className="space-y-5 relative z-10">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-2xl bg-white/5 text-(--main-color) border border-white/10 shadow-inner">
          ...
          {/* 🛡️ الكتلة الثانية: رسالتنا (بالخلفية البيضاء والشبكة الهندسية النظيفة) */}
          <motion.div
            initial={{ opacity: 0, x: isRtl ? -30 : 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            {/* شبكة خطوط هندسية خافتة جداً بالخلفية مستوحاة من لغة المخططات */}
            ...
            <span className="absolute top-8 left-8 text-7xl font-black text-(--alt-color)/5 group-hover:text-(--main-color)/5 transition-colors duration-500 font-mono select-none">
              02
            </span>
            ...
            <div className="space-y-5 relative z-10">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-2xl bg-gray-50 text-(--primary-color) group-hover:bg-red-50 group-hover:text-(--main-color) transition-all duration-500">
