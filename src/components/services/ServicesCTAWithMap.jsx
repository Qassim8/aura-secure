  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <div className="relative bg-gray-50 border border-gray-100/80 p-5 md:p-16 overflow-hidden select-none">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
            ...
            <div className="pt-4">
              <Link
                href={`/${locale}/contact`}
                className="inline-flex items-center gap-2 bg-(--primary-color) hover:bg-(--main-color) text-white px-4 md:px-8 py-4 font-black text-xs md:text-sm transition-all duration-300 tracking-wide cursor-pointer group shadow-md shadow-(--primary-color)/10"
              >
