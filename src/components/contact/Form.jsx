      ...
      <div className="bg-white p-8 md:p-12 shadow-[0_40px_80px_-30px_rgba(0,0,0,0.05)] border-t-8 border-(--primary-color)">
        ...
        >
          ...
          <div className="md:col-span-2 mt-4">
            <button
              className="group relative w-full md:w-auto px-12 py-4 bg-transparent text-(--main-color) border-2 border-(--main-color) overflow-hidden transition-all 
            ...
            >
              ...
              <span className="relative z-10 flex items-center justify-center gap-3 font-black text-xs uppercase tracking-[3px]">
                {t("Form_Btn")}
                <MdSend
